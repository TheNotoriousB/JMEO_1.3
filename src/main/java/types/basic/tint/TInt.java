...
*/
	...
	default TFloat to_tfloat(){
		return (TFloat) Factory.create_temporal(functions.tint_tfloat(getNumberInner()),"Float",getTemporalType());
	}
	...
	default IntSpan to_intspan(){
		return new IntSpan(functions.tnumber_span(getNumberInner()));
	}
