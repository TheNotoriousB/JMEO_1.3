...
//	}
	...
	public tstzspanset to_periodset() {
		return new tstzspanset(functions.set_spanset(this.get_inner()));
	}
	...
	public tstzspan to_span() {
		return new tstzspan(functions.set_span(this._inner));
	}

	public tstzspanset to_spanset() {
		return new tstzspanset(functions.set_spanset(this._inner));
	}
	...
	public Duration duration(){
		return ConversionUtils.interval_to_timedelta(functions.tstzspan_duration(functions.set_span(this._inner)));
	}
	...
	public boolean is_adjacent(TemporalObject other) throws Exception {
		if(other instanceof Span){
			...
			return functions.adjacent_span_span(functions.set_span(this._inner), ((Box) other).to_period().get_inner());
		}
		else{
			return super.is_adjacent((Base) other);
		}
	...
	public boolean is_contained_in(TemporalObject other) throws Exception {
		boolean returnValue;
		switch (other) {
			case tstzspan p -> returnValue = functions.contained_span_span(functions.set_span(this._inner), p.get_inner());
			case tstzspanset ps -> returnValue = functions.contained_spanset_spanset(functions.set_span(this._inner), ps.get_inner());
	...
	public boolean overlaps(TemporalObject other) throws Exception {
		boolean returnValue;
		switch (other) {
			case tstzspan p -> returnValue = functions.overlaps_span_span(functions.set_span(this._inner), p.get_inner());
			case tstzspanset ps -> returnValue = functions.overlaps_spanset_spanset(functions.set_spanset(this._inner), ps.get_inner());
	...
	public boolean is_after(TemporalObject other) throws Exception {
		boolean returnValue;
		switch (other) {
			case tstzspan p -> returnValue = functions.right_span_span(functions.set_span(this._inner), p.get_inner());
			case tstzspanset ps -> returnValue = functions.right_span_spanset(functions.set_span(this._inner), ps.get_inner());
	...
	public boolean is_before(TemporalObject other) throws Exception {
		boolean returnValue;
		switch (other) {
			case tstzspan p -> returnValue = functions.left_span_span(functions.set_span(this._inner), p.get_inner());
			case tstzspanset ps -> returnValue = functions.left_span_spanset(functions.set_span(this._inner), ps.get_inner());
	...
	public boolean is_over_or_after(TemporalObject other) throws Exception {
		boolean returnValue;
		switch (other) {
			case tstzspan p -> returnValue = functions.overright_span_span(functions.set_span(this._inner), p.get_inner());
			case tstzspanset ps -> returnValue = functions.overright_span_spanset(functions.set_span(this._inner), ps.get_inner());
	...
	public boolean is_over_or_before(TemporalObject other) throws Exception {
		boolean returnValue;
		switch (other) {
			case tstzspan p -> returnValue = functions.overleft_span_span(functions.set_span(this._inner), p.get_inner());
			case tstzspanset ps -> returnValue = functions.overleft_span_spanset(functions.set_span(this._inner), ps.get_inner());
...
//	}
	...
	public Time intersection(TemporalObject other) throws Exception {
		...
		switch (other) {
			case tstzspan p -> returnValue = new tstzspanset(functions.intersection_spanset_span(functions.set_spanset(this._inner), p.get_inner()));
			case tstzspanset ps -> returnValue = new tstzspanset(functions.intersection_spanset_spanset(functions.set_spanset(this._inner),ps.get_inner()));
	...
	public Time minus(TemporalObject other) throws Exception {
		Time returnValue = null;
		switch (other) {
			case tstzspan p -> returnValue = new tstzspanset(functions.minus_spanset_span(functions.set_spanset(this._inner), p.get_inner()));
			case tstzspanset ps -> returnValue = new tstzspanset(functions.minus_spanset_spanset(functions.set_spanset(this._inner),ps.get_inner()));
	...
	public Time union(TemporalObject other) throws Exception {
		Time returnValue = null;
		switch (other) {
			case tstzspan p -> returnValue = new tstzspan(functions.union_spanset_span(functions.set_spanset(this._inner),p.get_inner()));
			case tstzspanset ps -> returnValue = new tstzspanset(functions.union_spanset_spanset(functions.set_spanset(this._inner),ps.get_inner()));
