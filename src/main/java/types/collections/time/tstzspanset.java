...
//		super((Pointer) periods);
	...
	public boolean is_adjacent(TemporalObject other) throws Exception {
		...
		switch (other) {
			...
			case tstzset ts -> returnValue = functions.adjacent_spanset_spanset(this._inner, functions.set_spanset(ts.get_inner()));
	...
	public boolean contains(TemporalObject other) throws Exception {
		...
		switch (other) {
			...
			case tstzset ts -> returnValue = functions.contains_spanset_spanset(this._inner, functions.set_spanset(ts.get_inner()));
	...
	public boolean overlaps(TemporalObject other) throws Exception {
		...
		switch (other) {
			...
			case tstzset ts -> returnValue = functions.overlaps_spanset_spanset(this._inner, functions.set_span(ts.get_inner()));
	...
	public boolean is_before(TemporalObject other) throws Exception {
		...
		switch (other) {
			...
			case tstzset ts -> returnValue = functions.left_spanset_spanset(this._inner, functions.set_spanset(ts.get_inner()));
	...
	public boolean is_over_or_before(TemporalObject other) throws Exception {
		...
		switch (other) {
			...
			case tstzset ts -> returnValue = functions.overleft_spanset_span(this._inner, functions.set_span(ts.get_inner()));
	...
	public boolean is_after(TemporalObject other) throws Exception {
		...
		switch (other) {
			...
			case tstzset ts -> returnValue = functions.right_spanset_span(this._inner, functions.set_span(ts.get_inner()));
	...
	public boolean is_over_or_after(TemporalObject other) throws Exception {
		...
		switch (other) {
			...
			case tstzset ts -> returnValue = functions.overright_spanset_span(this._inner, functions.set_span(ts.get_inner()));
	...
	public Time intersection(Time other) {
		...
		switch (other) {
			...
			case tstzset ts -> returnValue = new tstzspan(functions.intersection_spanset_spanset(this._inner,functions.set_spanset(ts.get_inner())));
	...
	public tstzspanset minus(Time other) {
		...
		switch (other) {
			...
			case tstzset ts -> returnValue = new tstzspanset(functions.minus_spanset_spanset(this._inner,functions.set_spanset(ts.get_inner())));
			default -> throw new TypeNotPresentException(other.getClass().toString(), new Throwable("Operation not supported with this type"));
		}
		return returnValue;
	}
	...
	public tstzspanset union(Time other) {
		...
		switch (other) {
			...
			case tstzset ts -> returnValue = new tstzspanset(functions.union_spanset_spanset(this._inner,functions.set_spanset(ts.get_inner())));
			default -> throw new TypeNotPresentException(other.getClass().toString(), new Throwable("Operation not supported with this type"));
		}
		return returnValue;
	}
