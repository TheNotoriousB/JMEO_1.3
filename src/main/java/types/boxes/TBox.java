...
public class TBox implements Box {
	...
	public static TBox from_value_number(Number value)  {
		...
		if(value instanceof Integer){
			tbox = new TBox(functions.int_tbox((int)value));
		}
		else if (value instanceof Float){
			tbox = new TBox(functions.float_tbox((float)value));
		}
		return tbox;
	}
	...
	public static TBox from_value_span(Span span) {
		...
		if(span instanceof IntSpan){
			tbox = new TBox(functions.span_tbox(span.get_inner()));
		}
	...
	public static TBox from_time(Time time) throws Exception {
		...
		if (time instanceof tstzset){
			tbox = new TBox(functions.set_tbox(((tstzset) time).get_inner()));
		}
		else if (time instanceof tstzspan){
			tbox = new TBox(functions.span_tbox(((tstzspan) time).get_inner()));
		}
		else if (time instanceof tstzspanset){
			tbox = new TBox(functions.spanset_tbox(((tstzspanset) time).get_inner()));
		}
		else {
	...
	public static TBox from_tnumber(TNumber temporal){
		return new TBox(functions.tnumber_tbox(temporal.getNumberInner()));
	}
	...
	public FloatSpan to_floatspan(){
		return new FloatSpan(functions.tbox_floatspan(this._inner));
	}
	...
	public tstzspan to_period(){
		...
		return new tstzspan(functions.tbox_tstzspan(this._inner));
	}
	...
	public boolean is_adjacent_tbox(Object other) {
		...
		if (other instanceof TBox) {
			...
			result = functions.adjacent_tbox_tbox(this._inner,functions.tnumber_tbox(((TNumber) other).getNumberInner()));
	...
	public boolean is_contained_in(Object other)  {
		...
		if(other instanceof TBox){
			...
			result = functions.contained_tbox_tbox(this._inner,functions.tnumber_tbox(((TNumber) other).getNumberInner()));
		}
		return result;
	}
	...
	public boolean contains(Object other) {
		...
		if(other instanceof TBox){
			...
			result = functions.contains_tbox_tbox(this._inner, functions.tnumber_tbox(((TNumber) other).getNumberInner()));
		}
		return result;
	}
	...
	public boolean overlaps(Object other) {
		...
		if(other instanceof TBox){
			...
			result = functions.overlaps_tbox_tbox(this._inner, functions.tnumber_tbox(((TNumber) other).getNumberInner()));
		}
	...
	public boolean is_same(Object other)  {
		...
		if(other instanceof TBox){
			...
			result = functions.same_tbox_tbox(this._inner, functions.tnumber_tbox(((TNumber) other).getNumberInner()));
		}
	...
	public boolean is_left(Object other) {
		...
		if(other instanceof TBox){
			...
			result = functions.left_tbox_tbox(this._inner, functions.tnumber_tbox(((TNumber) other).getNumberInner()));
		}
	...
	public boolean is_over_or_left(Object other) {
		...
		if(other instanceof TBox){
			...
			result = functions.overleft_tbox_tbox(this._inner, functions.tnumber_tbox(((TNumber) other).getNumberInner()));
		}
	...
	public boolean is_right(Object other)  {
		...
		if(other instanceof TBox){
			...
			result = functions.right_tbox_tbox(this._inner, functions.tnumber_tbox(((TNumber) other).getNumberInner()));
		}
	...
	public boolean is_over_or_right(Object other)  {
		...
		if(other instanceof TBox){
			...
			result = functions.overright_tbox_tbox(this._inner, functions.tnumber_tbox(((TNumber) other).getNumberInner()));
		}
	...
	public boolean is_before(Object other)  {
		...
		if(other instanceof TBox){
			...
			result = functions.before_tbox_tbox(this._inner, functions.tnumber_tbox(((TNumber) other).getNumberInner()));
		}
	...
	public boolean is_over_or_before(Object other)  {
		...
		if(other instanceof TBox){
			...
			result = functions.overbefore_tbox_tbox(this._inner, functions.tnumber_tbox(((TNumber) other).getNumberInner()));
		}
	...
	public boolean is_after(Object other)  {
		...
		if(other instanceof TBox){
			...
			result = functions.after_tbox_tbox(this._inner, functions.tnumber_tbox(((TNumber) other).getNumberInner()));
		}
	...
	public boolean is_over_or_after(Object other) {
		...
		if(other instanceof TBox){
			...
			result = functions.overafter_tbox_tbox(this._inner, functions.tnumber_tbox(((TNumber) other).getNumberInner()));
		}
	...
	public boolean is_float(){
		...
		tstzspan t= new tstzspan(functions.stbox_tstzspan(this._inner));
