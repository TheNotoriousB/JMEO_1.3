...
public class tstzspan extends Span<LocalDateTime> implements Time, TimeCollection{
	...
	public tstzspanset to_spanset(){
		return new tstzspanset(functions.span_spanset(this._inner));
	}
...
//	}
	...
	public boolean is_adjacent(TemporalObject other) throws Exception {
		...
		switch (other) {
			...
			case tstzset ts -> returnValue = functions.adjacent_spanset_spanset(this._inner, functions.set_span(ts.get_inner()));
			case Temporal t -> returnValue = functions.adjacent_span_span(this._inner,functions.temporal_tstzspan(t.getInner()));
	...
	public boolean contains(TemporalObject other) throws Exception {
		...
		switch (other){
			...
			case tstzset ts -> returnValue = functions.contains_span_span(this._inner,functions.set_span(ts.get_inner()));
	...
	public boolean overlaps(TemporalObject other) throws Exception {
		...
		switch (other){
			...
			case tstzset ts -> returnValue = functions.overlaps_span_span(this._inner,functions.set_span(ts.get_inner()));
	...
	public boolean is_same(TemporalObject other) throws Exception {
		...
		switch (other){
			...
			case tstzset ts -> returnValue = functions.span_eq(this._inner,functions.set_span(ts.get_inner()));
	...
	public boolean is_before(TemporalObject other) throws Exception {
		...
		switch (other){
			...
			case tstzset ts -> returnValue = functions.left_span_span(this._inner,functions.set_span(ts.get_inner()));
	...
	public boolean is_over_or_before(TemporalObject other) throws Exception {
		...
		switch (other){
			...
			case tstzset ts -> returnValue = functions.overleft_span_span(this._inner,functions.set_span(ts.get_inner()));
	...
	public boolean is_after(TemporalObject other) throws Exception {
		...
		switch (other){
			...
			case tstzset ts -> returnValue = functions.right_span_span(this._inner,functions.set_span(ts.get_inner()));
	...
	public boolean is_over_or_after(TemporalObject other) throws Exception {
		...
		switch (other){
			...
			case tstzset ts -> returnValue = functions.overright_span_span(this._inner,functions.set_span(ts.get_inner()));
    ...
    public Time intersection(TemporalObject other) throws Exception {
        ...
        switch (other){
            ...
            case tstzset ts -> returnValue = new tstzset(functions.intersection_spanset_span(functions.set_spanset(ts.get_inner()),this._inner));
	...
	public tstzspanset minus(Time other)  {
		...
		switch (other){
			...
			case tstzset ts -> returnValue = new tstzspanset(functions.minus_span_spanset(this._inner,functions.set_spanset(ts.get_inner())));
			default -> throw new TypeNotPresentException(other.getClass().toString(), new Throwable("Operation not supported with this type"));
		}
		return returnValue;
	}
	...
	public tstzspanset union(Time other)  {
		...
		switch (other){
			...
			case tstzset ts -> returnValue = new tstzspanset(functions.union_spanset_span(functions.set_spanset(ts.get_inner()),this._inner));
			default -> throw new TypeNotPresentException(other.getClass().toString(), new Throwable("Operation not supported with this type"));
		}
		return returnValue;
	}
