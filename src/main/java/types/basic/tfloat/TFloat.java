...
*/
	...
	default TInt to_tint(){
		return (TInt) Factory.create_temporal(functions.tfloat_tint(getNumberInner()),"Integer",getTemporalType());
	}
	...
	default FloatSpan to_floatrange(){
		return new FloatSpan(functions.tnumber_span(getNumberInner()));
	}
